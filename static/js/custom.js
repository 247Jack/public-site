...
(function($){
	...
	AZOM.Accordion = function() {
		$('.accordion').each(function (i, elem) {
	       	var $elem = $(this),
	           $acpanel = $elem.find(".AZOM-group > .AZOM-des"),
	           $acsnav =  $elem.find(".AZOM-group > .AZOM-heading");
	          $acpanel.hide().first().slideDown("easeOutExpo");
	          $acsnav.first().parent().addClass("AZOM-active");
	          $acsnav.on('click', function () {
	            if(!$(this).parent().hasClass("AZOM-active")){
	              var $this = $(this).next(".AZOM-des");
	              $acsnav.parent().removeClass("AZOM-active");
	              $(this).parent().addClass("AZOM-active");
	              $acpanel.not($this).slideUp("easeInExpo");
	              $(this).next().slideDown("easeOutExpo");
	            }else{
	               $(this).parent().removeClass("AZOM-active");
